...
(async () => {
  ...
  assert.match(server, /const shouldBufferAssistantAudio = \(\) =>[\s\S]*assistantAudioFlushRunning;/, 'server should keep buffering assistant audio while a turn or flush is still in flight');
